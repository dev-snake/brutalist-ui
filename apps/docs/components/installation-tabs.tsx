...
const componentImports: Record<string, string[]> = {
    ...
    spinner: ['Spinner'],
    toast: ['Toast', 'ToastAction', 'ToastClose', 'ToastDescription', 'ToastTitle', 'ToastProvider', 'ToastViewport'],
    skeleton: ['Skeleton'],
    calendar: ['Calendar'],
    'context-menu': [
        'ContextMenu',
...
export function InstallationTabs({
    ...
    const imports = customImports || componentImports[componentName] || [
        componentName
            .split('-')
        ...
        <div className="space-y-4">
            ...
            {activeTab === 'cli' ? (
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <p className="text-sm font-bold mb-2 text-gray-600 dark:text-gray-400">
                            3. Save to <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">components/ui/{componentName}.tsx</code>
                        </p>
                    </div>
