...
export default function CardPage() {
    return (
        <div>
            ...
            <h2>Preview</h2>
            <ComponentPreview className="bg-gray-100">
  ...
  CardFooter,
            ...
            <div className="grid gap-4 my-4">
                ...
                <Card padding="default" className="max-w-sm">
            ...
            <div className="overflow-x-auto">
                <table className="w-full border-3 border-black">
                    <thead className="bg-[#FFE66D]">
                        <tr>
                            <th className="px-4 py-2 text-left border-r-3 border-b-3 border-black font-black">
                                Prop
                            </th>
                            <th className="px-4 py-2 text-left border-r-3 border-b-3 border-black font-black">
                                Type
                            </th>
                            <th className="px-4 py-2 text-left border-b-3 border-black font-black">
                                Default
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className="border-b-3 border-black">
                            <td className="px-4 py-2 border-r-3 border-black font-medium">
                                variant
                            </td>
                            <td className="px-4 py-2 border-r-3 border-black text-sm">
